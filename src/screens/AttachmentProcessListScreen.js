...
import { ActivityIndicator, View, FlatList, StyleSheet, TouchableOpacity, ToastAndroid } from 'react-native'
...
export default function AttachmentProcessListScreen({ route }) {
  ...
  async function handleLoadData() {
    ...
    try {
      const { data } = await ADVService.get(`/api/v1/app/processos/${key}/attachment`)
